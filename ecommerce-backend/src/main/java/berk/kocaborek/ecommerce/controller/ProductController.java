...
public class ProductController {
    ...
    @GetMapping("/browse")
    public ResponseEntity<ProductBrowseResponse> browseProducts(
        ...
        return ResponseEntity.ok(productService.browseProducts(category, search, minPrice, maxPrice, sort, page, size));
    }
