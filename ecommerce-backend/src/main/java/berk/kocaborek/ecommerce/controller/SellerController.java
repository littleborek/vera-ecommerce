...
public class SellerController {
    ...
    public ResponseEntity<List<OrderDTO>> getOrdersForSeller() {
        List<OrderDTO> orders = orderService.getOrdersForCurrentSeller();
    ...
    public ResponseEntity<OrderDTO> updateOrderStatusForSeller(
        ...
        return ResponseEntity.ok(orderService.updateOrderStatusForCurrentSeller(orderId, status));
    }
    ...
    public ResponseEntity<List<PaymentDTO>> getPaymentsForSeller() {
        List<PaymentDTO> payments = paymentService.getPaymentsForCurrentSeller();
